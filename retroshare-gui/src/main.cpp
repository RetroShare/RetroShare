...
static void displayWarningAboutDSAKeys()
{
    ...
    msgBox.setWindowIcon(QIcon(":/app/images/icon.png")); //Duy replace :/icons/logo_128.png
...
feenableexcept(FE_INVALID | FE_DIVBYZERO);
	...
	if (initResult < 0) {
        ...
        mb.setWindowIcon(QIcon(":/app/images/icon.png")); //Duy replace :/icons/logo_128.png
