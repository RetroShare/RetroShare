...
public:
	...
	RsAction(QWidget * parent, const std::string &rsid);
	RsAction(const QString & text, QObject * parent, const std::string &rsid);
	RsAction(const QIcon & icon, const QString & text, QObject * parent , const std::string &rsid);
