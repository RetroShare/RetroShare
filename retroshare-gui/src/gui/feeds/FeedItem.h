...
enum class RsFeedTypeFlags: uint32_t {
    ...
    RS_FEED_TYPE_CONNECTION_REFUSED_REMOTELY = 0x2000,
    ...
    RS_FEED_ITEM_SEC_IP_BLACKLISTED                = RS_FEED_TYPE_CONNECTION_REFUSED_REMOTELY  | 0x0001,
    RS_FEED_ITEM_SEC_IP_WRONG_EXTERNAL_IP_REPORTED = RS_FEED_TYPE_CONNECTION_REFUSED_REMOTELY  | 0x0002,
