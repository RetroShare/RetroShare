...
public:
	...
	enum Columns {
		...
		COLUMN_THREAD_PIN          =0x01,
		COLUMN_THREAD_READ         =0x02,
		COLUMN_THREAD_DATE         =0x03,
		COLUMN_THREAD_DISTRIBUTION =0x04,
		COLUMN_THREAD_AUTHOR       =0x05,
		COLUMN_THREAD_CONTENT      =0x06,
		COLUMN_THREAD_MSGID        =0x07,
		COLUMN_THREAD_DATA         =0x08,
