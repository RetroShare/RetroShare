...
const char* subclassname(Fl_Item *i) {
    return i -> type_name();
}
...
void *Fl_Tree_Browser::item_first() const {
    return Fl_Item::first;
}

void *Fl_Tree_Browser::item_next(void *l) const {
    return ((Fl_Item*)l)->next;
}

void *Fl_Tree_Browser::item_prev(void *l) const {
    return ((Fl_Item*)l)->prev;
}

int Fl_Tree_Browser::item_selected(void *l) const {
    return ((Fl_Item*)l)->new_selected;
}

void Fl_Tree_Browser::item_select(void *l,int v) {
    ((Fl_Item*)l)->new_selected = v;
}
...
Fl_Item* Fl_Item::click_test(int,int) {
    return 0;
}
...
int Fl_Item::is_parent() const {
    return 0;
}
int Fl_Item::is_widget() const {
    return 0;
}
int Fl_Item::is_valuator() const {
    return 0;
}
int Fl_Item::is_button() const {
    return 0;
}
int Fl_Item::is_menu_item() const {
    return 0;
}
int Fl_Item::is_menu_button() const {
    return 0;
}
int Fl_Item::is_group() const {
    return 0;
}
int Fl_Item::is_window() const {
    return 0;
}
int Fl_Item::is_code_block() const {
    return 0;
}
int Fl_Item::is_decl_block() const {
    return 0;
}
int Fl_Item::is_class() const {
    return 1;
}
int Fl_Item::is_public() const {
    return 1;
}
int Fl_Item::is_file() const {
    return 0;
}

int Fl_File_Item::is_public()const {
    return 1;
}
int Fl_Dir_Item::is_public()const {
    return 1;
}
int Fl_File_Item::is_parent() const {
    return 0;
}
int Fl_Dir_Item::is_parent() const {
    return 1;
}

int Fl_Person_Item::is_public()const {
    return 1;
}
int Fl_Person_Item::is_parent() const {
    return 1;
}
int Fl_Msg_Item::is_public()const {
    return 1;
}
int Fl_Msg_Item::is_parent() const {
    return 0;
}
...
void Fl_Item::move_before(Fl_Item* g) {
    ...
    prev->next = n;
    if (n) n->prev = prev;
    else Fl_Item::last = prev;
    prev = g->prev;
    l->next = g;
    if (prev) prev->next = this;
    else Fl_Item::first = this;
    g->prev = l;
